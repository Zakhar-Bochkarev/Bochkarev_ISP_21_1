<HTML>
    ...
    echo " </div>";
    echo " <div class='main stylesix'>";
    echo " <div class='block_up'>";
    echo " <h1 class='Tusk_text__six'>Вычислить значение функции y=f(x) при произвольных значениях x. Варианты заданий в таблице 2. Для вычисления значения функции использовать оператор switch.</h1>";
